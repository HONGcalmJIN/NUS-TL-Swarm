...
namespace helper
{
    ...
    geometry_msgs::msg::Point vector_to_point(Eigen::Vector3d v)
    {
    ...
    Eigen::Vector3d point_to_vector(geometry_msgs::msg::Point p)
    {
        Eigen::Vector3d tmp;
        tmp.x() = p.x; 
        tmp.y() = p.y; 
    ...
    geometry_msgs::msg::Vector3 vector_to_ros_vector(Eigen::Vector3d v)
    {
    ...
    Eigen::Vector3d ros_vector_to_vector(geometry_msgs::msg::Vector3 rv)
    {
        Eigen::Vector3d tmp;
        tmp.x() = rv.x; 
        tmp.y() = rv.y; 
    ...
    geometry_msgs::msg::Quaternion quaternion_to_orientation(
        Eigen::Quaterniond q)
    {
    ...
    Eigen::Affine3d posestamped_to_affine(geometry_msgs::msg::PoseStamped ps)
    {
